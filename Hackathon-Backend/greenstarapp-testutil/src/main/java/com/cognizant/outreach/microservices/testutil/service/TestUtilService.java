...
/**
 * Service to insert mock test data with below scenarios
 * 1. create 8 schools(4 schools for one sate and 4 school for other state. Out of 4 school 2 school
 *    on two different district)
 * 2. Each school will have two classes
 * 3. Each class will have 10 students. 5 members on a team
 * 4. All students will have parameter entries for academic month june1- april30 
 *    (This will be different to capture major scenario's)
 * 5. Each school will have parameters as Homework,Attendance,Discipline
 * 6. Each school will have holidays configured 
 * 7. Each school will have weekend working days configured
 *  These mock data can be updated on the test cases based on the unit testing scenario
 * 
 * @author 371793
 */
@Service
public class TestUtilService {
	...
	@Transactional
	public void createTestData() throws ParseException, IOException {
		initMaps();

		schools = schoolHelper.createSchools();

		// Create holidays,weekend working days, parameter, classes,students & paramvalue for 10 months for each school
		...
		System.out.println("Master data loaded for all the schools");
	}
	
	@Transactional
	public void createMeasurableParamData() throws ParseException, IOException {
		System.out.println("MeasurableParamData Loading..");
		paramDataIds = measurableParamDataHelper.createParamData(schoolClassStudentAssocMap,
				classDetailMap, measurableParamMap);
		System.out.println("MeasurableParamData Loaded for all the schools & students for 10 months!");
	}
	...
	public void deleteTestData() {
		System.out.println("Deleting all test mock data....");
		...
		System.out.println("Deleting all test mock data Completed!");
	}
